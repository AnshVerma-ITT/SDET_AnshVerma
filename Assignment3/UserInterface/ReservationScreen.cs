...
namespace GourmetSpot.UserInterface
{
    public class ReservationScreen
    {
        ...
        private void DisplayAvailableTables(DateTime reservationDateTime)
        {
            ...
            Console.WriteLine($"\nAvailable Tables for {reservationDateTime:dd-MM-yyyy HH:mm} to {reservationDateTime.AddHours(ReservationManager.ReservationWindowHours):HH:mm}:");
