...
WebUI.click(findTestObject('Inventory/button_react-burger-menu-btn'))

WebUI.click(findTestObject('Inventory/a_logout_sidebar_link'))
...
WebUI.assertElementText(findTestObject('Login/input_login-button'), 'Login', 0)
