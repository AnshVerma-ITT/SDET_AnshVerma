...
WebUI.assertElementText(findTestObject('Page_Swag Labs/select_Name (A to Z)Name (Z to A)Price (low to h'), 'Name (A to Z)Name (Z to A)Price (low to high)Price (high to low)', 
    0)
...
WebUI.assertElementPresent(findTestObject('Page_Swag Labs/select_Name (A to Z)Name (Z to A)Price (low to h'), 0)
